...
impl MeanStaticEmbedder {
    ...
    /// Quantized embedding using u8 to the values [-127, 127]
    pub fn embed_quant_i8(&self, tokens: &[usize]) -> Vec<i8> {
    ...
    pub fn from_buffer(dim: usize, buffer: &[u8], endianness: Endianness) -> Self {
